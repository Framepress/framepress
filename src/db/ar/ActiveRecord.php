...
abstract class ActiveRecord {
	 ...
	 *        	(optional) The attributes of the model
	 */
	 ...
	 * Save the model
	 *
	 * @return \beststripclub\affiliate\util\ar\Model The model object
	 */
	 ...
	 * Delete the model
	 *
	 * @return \beststripclub\affiliate\util\ar\Model The model instance
	 */
	 ...
	 *        	
	 * @return \beststripclub\affiliate\util\ar\Model An model instance
	 */
	 ...
	 *
	 * @return \beststripclub\affiliate\util\ar\Query A query instance
	 */
	...
	public static function insert(array $data) {
		static::query ()->insert ( $data )->execute ();
	 ...
	 *
	 * @see \beststripclub\affiliate\util\ar\Query::update
	 *
	 ...
	 *        	
	 * @return \beststripclub\affiliate\util\ar\Query The current query object
	 */
	...
	public static function delete_by_id($id) {
		static::query ()->delete ()->where ( 'id', $id )->execute ();
	}
	 ...
	 *
	 * @param string $name
	 *        	The name of the non existing method
	 * @param array $arguments
	 *        	The arguments of the non existing method
	 *        	
