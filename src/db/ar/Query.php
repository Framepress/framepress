...
class Query {
	 ...
	 *
	 * @var string null current model or table name
	 */
	protected $model;
	 ...
	 *
	 * @param string $model
	 *        	(optional) A class name of a wp_activerecord\Model class or a table name
	 * @param boolean $isModel
	 *        	(optional) Flag for checking if $model is a class name
	 */
	 ...
	 *        	(optional) A column name or a data object
	 * @param string $value
	 *        	(optional) A value of a column
	 *        	
	 * @return \wp_activerecord\Query The current query object
	 */
	 ...
	 *
	 * @param string|array $column
	 *        	A column name or a data object
	 * @param string $value
	 *        	(optional) A value of a column
	 *        	
	 * @return \wp_activerecord\Query The current query object
	 ...
	 *
	 * @param array $data
	 *        	One data object or multiple rows
	 *        	
	 * @return \wp_activerecord\Query The current query object
	 */
	 ...
	 *
	 * @param string|array $column
	 *        	A column name, a raw condition wrapped in an array or multiple
	 *        	where conditions in an array
	 * @param mixed $type_or_value
	 *        	(optional) The type of the query (e.g. = or >) or the value of the column
	 * @param mixed $value
	 ...
	 *
	 * @param string|array $column
	 *        	The column name or the raw string wrapped in an array
	 * @param string|boolean $order
	 *        	(optional) The order of the grouping, ASC/true or DESC/false
	 *        	
	 * @return \wp_activerecord\Query The current query object
	 */
	 ...
	 *        	The limit number or a raw string wrapped in an array
	 *        	
	 ...
	 *
	 * @param int|string|array $limit
	 *        	The offset number or a raw string wrapped in an array
	 *        	
	 * @return \wp_activerecord\Query
	 */
	...
	public function get_total() {
		return count ( static::wpdb ()->get_results ( $this->sql () ) );
	}
